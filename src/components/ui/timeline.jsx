  ...
  return (
    (<div
      ...
      <div className="max-w-7xl mx-auto py-10 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl sm:mb-[-100px] text-black dark:text-white max-w-4xl font-semibold">
          Meet the Founders
        </h2>
        {/* <p
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-2 md:pt-40 md:gap-10">
            <div
